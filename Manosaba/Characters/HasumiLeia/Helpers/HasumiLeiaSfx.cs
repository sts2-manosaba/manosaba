...
namespace manosaba.Characters.HasumiLeia.Helpers;
...
/// </summary>
public sealed class HasumiLeiaSfx : CharacterSfxBase
{
    public static readonly HasumiLeiaSfx Instance = new();

    // ===== A 區：角色層級（BaseLib CustomAttackSfx / CustomCastSfx；由 TriggerAnim Attack/Cast 觸發）=====
    // 建議路徑（與 Sherry 同層）：res://Manosaba/audio/SFX/hasumi_leia/
    // public override string? CharacterAttack => "event:/Manosaba/audio/SFX/hasumi_leia/attack.ogg";
    // public override string? CharacterCast => "event:/Manosaba/audio/SFX/hasumi_leia/cast.ogg";
    // public override string? CharacterDeath => "event:/Manosaba/audio/SFX/hasumi_leia/death.ogg";
