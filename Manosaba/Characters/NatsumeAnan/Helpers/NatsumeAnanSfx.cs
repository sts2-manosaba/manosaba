...
namespace manosaba.Characters.NatsumeAnan.Helpers;
...
/// </summary>
public sealed class NatsumeAnanSfx : CharacterSfxBase
{
    public static readonly NatsumeAnanSfx Instance = new();

    // ===== A 區：角色層級（BaseLib CustomAttackSfx / CustomCastSfx；由 TriggerAnim Attack/Cast 觸發）=====
    // 建議路徑（與 Sherry 同層）：res://Manosaba/audio/SFX/natsume_anan/
    // public override string? CharacterAttack => "event:/Manosaba/audio/SFX/natsume_anan/attack.ogg";
    // public override string? CharacterCast => "event:/Manosaba/audio/SFX/natsume_anan/cast.ogg";
    // public override string? CharacterDeath => "event:/Manosaba/audio/SFX/natsume_anan/death.ogg";
