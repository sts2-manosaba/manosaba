...
namespace manosaba.Characters.SaekiMiria.Helpers;
...
/// </summary>
public sealed class SaekiMiriaSfx : CharacterSfxBase
{
    public static readonly SaekiMiriaSfx Instance = new();

    // ===== A 區：角色層級（BaseLib CustomAttackSfx / CustomCastSfx；由 TriggerAnim Attack/Cast 觸發）=====
    // 建議路徑（與 Sherry 同層）：res://Manosaba/audio/SFX/saeki_miria/
    // public override string? CharacterAttack => "event:/Manosaba/audio/SFX/saeki_miria/attack.ogg";
    // public override string? CharacterCast => "event:/Manosaba/audio/SFX/saeki_miria/cast.ogg";
    // public override string? CharacterDeath => "event:/Manosaba/audio/SFX/saeki_miria/death.ogg";
