...
namespace manosaba.Characters.ShitoAlisa.Helpers;
...
/// </summary>
public sealed class ShitoAlisaSfx : CharacterSfxBase
{
    public static readonly ShitoAlisaSfx Instance = new();

    // ===== A 區：角色層級（BaseLib CustomAttackSfx / CustomCastSfx；由 TriggerAnim Attack/Cast 觸發）=====
    // 建議路徑（與 Sherry 同層）：res://Manosaba/audio/SFX/shito_alisa/
    // public override string? CharacterAttack => "event:/Manosaba/audio/SFX/shito_alisa/attack.ogg";
    // public override string? CharacterCast => "event:/Manosaba/audio/SFX/shito_alisa/cast.ogg";
    // public override string? CharacterDeath => "event:/Manosaba/audio/SFX/shito_alisa/death.ogg";
