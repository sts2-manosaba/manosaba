...
/// </summary>
public sealed class KurobeNanokaSfx : CharacterSfxBase
{
    public static readonly KurobeNanokaSfx Instance = new();

    // ===== A 區：角色層級（BaseLib CustomAttackSfx / CustomCastSfx；由 TriggerAnim Attack/Cast 觸發）=====
    // 建議路徑（與 Sherry 同層）：res://Manosaba/audio/SFX/kurobe_nanoka/
    // public override string? CharacterAttack => "event:/Manosaba/audio/SFX/kurobe_nanoka/attack.ogg";
    // public override string? CharacterCast => "event:/Manosaba/audio/SFX/kurobe_nanoka/cast.ogg";
    // public override string? CharacterDeath => "event:/Manosaba/audio/SFX/kurobe_nanoka/death.ogg";
