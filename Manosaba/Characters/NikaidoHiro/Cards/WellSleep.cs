...
namespace Manosaba.Characters.NikaidoHiro.Cards
{
    ...
    public class WellSleep : PathCustomCardModel
    {
        ...
        protected override IEnumerable<DynamicVar> CanonicalVars => [new BlockVar(5, ValueProp.Move), new PowerVar<SusPower>(2)];
