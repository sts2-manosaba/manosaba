...
namespace manosaba.Characters.NikaidoHiro.Helpers;
...
/// </summary>
public sealed class NikaidoHiroSfx : CharacterSfxBase
{
    public static readonly NikaidoHiroSfx Instance = new();

    // ===== A 區：角色層級（BaseLib CustomAttackSfx / CustomCastSfx；由 TriggerAnim Attack/Cast 觸發）=====
    // 建議路徑（與 Sherry 同層）：res://Manosaba/audio/SFX/nikaido_hiro/
    // public override string? CharacterAttack => "event:/Manosaba/audio/SFX/nikaido_hiro/attack.ogg";
    // public override string? CharacterCast => "event:/Manosaba/audio/SFX/nikaido_hiro/cast.ogg";
    // public override string? CharacterDeath => "event:/Manosaba/audio/SFX/nikaido_hiro/death.ogg";
