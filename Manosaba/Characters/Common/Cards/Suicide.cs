...
namespace Manosaba.Characters.Common.Cards
{
    ...
    public class Suicide : PathCustomCardModel
    {
        ...
        protected override IEnumerable<DynamicVar> CanonicalVars => [new DamageVar(1, ValueProp.Unpowered), new PowerVar<VotePower>(2)];
        ...
        {
            base.DynamicVars["VotePower"].UpgradeValueBy(1m);
        }
    }
}
