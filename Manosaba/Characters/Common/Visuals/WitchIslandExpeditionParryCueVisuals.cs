...
public sealed partial class WitchIslandExpeditionParryCueNode : Node2D
{
    ...
    private const float BeamScaleX = 0.74f;
    private const float BeamScaleY = 0.86f;
    private const float HaloScaleX = 1.55f;
    private const float HaloScaleY = 0.44f;
    private const float CoreScale = 0.52f;
    private const float GlintScaleX = 0.58f;
    private const float GlintScaleY = 0.12f;
    ...
    {
        if (_halo == null || _beam == null || _core == null || _whiteGlint == null)
        {
            return;
        }
