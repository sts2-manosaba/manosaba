...
namespace manosaba.Characters.HikamiMeruru.Helpers;
...
/// </summary>
public sealed class HikamiMeruruSfx : CharacterSfxBase
{
    public static readonly HikamiMeruruSfx Instance = new();

    // ===== A 區：角色層級（BaseLib CustomAttackSfx / CustomCastSfx；由 TriggerAnim Attack/Cast 觸發）=====
    // 建議路徑（與 Sherry 同層）：res://Manosaba/audio/SFX/hikami_meruru/
    // public override string? CharacterAttack => "event:/Manosaba/audio/SFX/hikami_meruru/attack.ogg";
    // public override string? CharacterCast => "event:/Manosaba/audio/SFX/hikami_meruru/cast.ogg";
    // public override string? CharacterDeath => "event:/Manosaba/audio/SFX/hikami_meruru/death.ogg";
