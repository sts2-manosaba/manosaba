...
namespace manosaba.Characters.JogasakiNoah.Helpers;
...
/// </summary>
public sealed class JogasakiNoahSfx : CharacterSfxBase
{
    public static readonly JogasakiNoahSfx Instance = new();

    // ===== A 區：角色層級（BaseLib CustomAttackSfx / CustomCastSfx；由 TriggerAnim Attack/Cast 觸發）=====
    // 建議路徑（與 Sherry 同層）：res://Manosaba/audio/SFX/jogasaki_noah/
    // public override string? CharacterAttack => "event:/Manosaba/audio/SFX/jogasaki_noah/attack.ogg";
    // public override string? CharacterCast => "event:/Manosaba/audio/SFX/jogasaki_noah/cast.ogg";
    // public override string? CharacterDeath => "event:/Manosaba/audio/SFX/jogasaki_noah/death.ogg";
